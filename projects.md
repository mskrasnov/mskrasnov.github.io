...
Ferrix - простой системный профилировщик для Linux. Написан на Rust с применением `iced`. Пока нет поддержки бенчмарков, но активно думаю над добавлением некоторых из них.
