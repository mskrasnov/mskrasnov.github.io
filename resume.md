...
**Желаемая должность:** стажёр / junior-разработчик (Rust, Linux, Python)<br>**Место работы:** готов работать удалённо или очно в Дзержинске.<br>**Занятость:** полная, частичная, стажировка
