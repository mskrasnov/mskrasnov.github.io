...
Ferrix содержит функции для отображения информации о сервисах systemd и списке установленного ПО (`flatpak`, `deb`, `rpm`). Это выгодно отличает эту программу от аналогов.
