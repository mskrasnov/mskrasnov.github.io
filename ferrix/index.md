...
[Скачать последнюю версию](https://github.com/mskrasnov/FSM/releases/latest) | [Репозиторий для Debian](https://gitverse.ru/mskrasnov/-/packages/debian/ferrix-app/0.6.0-1?tab=packages)
