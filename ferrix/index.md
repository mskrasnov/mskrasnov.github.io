...
[![](./assets/antiX.png)](./assets/antiX.png)

## Скачать

На данный момент поддерживаются архитектуры `x86_64` и `aarch64` (триплеты: `x86_64-unknown-linux-gnu`, `aarch64-unknown-linux-gnu`).
